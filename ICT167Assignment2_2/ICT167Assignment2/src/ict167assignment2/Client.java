    ...
    public static void loadStudentsFromCSV(String fileName) {
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String enrolmentType = data[4].trim();
                if (type.equals("C")) {
                    students.add(new Student_Course(firstName, lastName, studentNumber, enrolmentType));
                } else if (type.equals("R")) {
                    students.add(new Student_Research(firstName, lastName, studentNumber, enrolmentType));
                }
            }
        ...
        try (FileWriter writer = new FileWriter("sorted_students.csv")) {
            for (Student student : students) {
                ...
                writer.write(type + "," + student.getFirstName() + "," + student.getLastName() + "," +
                        student.getStudentNumber() + "," + student.getEnrolmentType() + "\n");
            }
