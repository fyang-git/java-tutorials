...
public class Client {
    ...
    public static void main(String[] args) 
    {
        ...
        public static void loadStudentsFromCSV(String fileName) {
            ...
            {
                // CSV format for coursework students includes unit details and marks
            ...
            // Research student     
               (enrolmentType.equals("R")) { 
                // CSV format for research students includes proposal and dissertation marks
